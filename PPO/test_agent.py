...
def test_agent(number_games, checkpoint_filename, render,checkpoint_info="best", weak_opponent=False,checkpoint_selfplay_filename=None,checkpoint_selfplay_info="best"):
    ...
    if checkpoint_selfplay_filename is None:
        ...
        opponent = Agent()
        opponent.load(checkpoint_selfplay_filename,checkpoint_selfplay_info)
